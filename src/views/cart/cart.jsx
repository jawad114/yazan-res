...
//                     </IconButton>
//                     <IconButton 
//                           onClick={() => setSelectedRestaurant(product.orderFrom)} // Set the selected restaurant
//                         >
//                   <ReceiptOutlined/>
//                 </IconButton>
//                 </div>
...
//       )}
//                     <Typography variant="h6" className='text-right mt-4'>
//               ₪ {calculateTotalPrice(cartItem)} :اجمالي السعر
//               </Typography>
//                         <Typography variant="body2" color="textSecondary">
...
//                         </IconButton>
//                         <IconButton 
//                           onClick={() => triggerReceipt(product.orderFrom)} // Trigger receipt handling
//                         >
//                           <ReceiptOutlined/>
//                         </IconButton>
//                       </div>
...
//                           )}
//                           <Typography variant="h6" className='text-right mt-4'>
//                           اجمالي السعر: ₪ {calculateTotalPrice(product)}
//                           </Typography>
//                           <Typography variant="body2" color="textSecondary">
//                             {product.orderFrom || 'Not Found'}
//                           </Typography>
...
//                     افراغ السلة
//                   </Button>
//                   {/* Remove the checkout button, as requested */}
//                 </div>
//               </div>
//             ) : (
//               <Typography variant="body1" className='text-center mt-6'>
...
import { useNavigate } from 'react-router-dom';
import Carousels from '../../Home/Carousels/Carousels';
import { Receipt, ReceiptLong, ReceiptOutlined } from '@mui/icons-material';
