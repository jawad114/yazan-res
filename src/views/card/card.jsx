...
export default function Card({ product }) {
  ...
  const addToFavorites = async () => {
    try {
      ...
      await axios.post(`https://yazan-4.onrender.com/add-to-favorites/${id}`, { restaurantName });
      setIsFavorite(true);
  ...
  const removeFromFavorites = async () => {
    try {
      ...
      await axios.delete(`https://yazan-4.onrender.com/remove-from-favorites/${id}`, { data: { restaurantName } });
      setIsFavorite(false);
  ...
  const handleDelete = async () => {
    ...
    if (confirmed) {
      try {
        ...
        await axios.delete(`https://yazan-4.onrender.com/delete-restaurant/${restaurantName}`);
